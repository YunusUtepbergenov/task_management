...
$(document).ready(function () {
    ...
    $(document).on("change", "#add_task_select", function () {
        $("#add_task_employee").prop("selectedIndex", 0);
    });
...
function editTask(id) {
    $.get("/task/info/byid/" + id, function (task) {
        $("#id1").val(task.id);
        $("#name1").val(task.name);
        $("#deadline1").val(task.deadline);
        $("#priority1").val(task.priority).change();
        $("#description1").val(task.description);
    });
}
